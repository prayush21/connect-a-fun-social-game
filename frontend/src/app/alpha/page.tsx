        ...
        <div className="space-y-4 border-t border-gray-200 pt-8">
          ...
          <ol className="space-y-3 text-sm text-gray-600">
            ...
            <li className="flex gap-3">
              ...
              <span>
                Players give clues by providing reference words that relate to
                the secret word
              </span>
            </li>
            <li className="flex gap-3">
              ...
              <span>
                Guessers try to figure out the secret word based on the clues
                given
              </span>
            </li>
            <li className="flex gap-3">
              ...
              <span>
                Work together to solve the word within the time limit!
              </span>
            </li>
          </ol>
        </div>
